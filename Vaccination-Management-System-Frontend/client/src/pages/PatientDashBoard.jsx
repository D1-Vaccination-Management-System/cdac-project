...
import Certificate from "../components/DownLoadCertificate";
  ...
  return (
    <div className="flex">
      ...
      <div className="flex-1 p-5">
        {selectedComponent === "UpdateProfile" && <UpdateProfile setSelectedComponent={setSelectedComponent}  />}
        {selectedComponent === "UpdateAddress" && <UpdateAddress setSelectedComponent={setSelectedComponent} />}
        {selectedComponent === "certificate" && <Certificate />}
        {selectedComponent === "DeleteProfile" && <DeleteProfile setSelectedComponent={setSelectedComponent} />}
	      {selectedComponent === null && <>
              ...
              <div className="flex-1 p-5">
              {innerComponent === "ScheduleAppointment" && <ScheduleAppointment setInnerComponent={setInnerComponent}  />}
              {innerComponent === "ShowUpcomingAppointments" && <UpcomingAppointments setInnerComponent={setInnerComponent} />}
              {innerComponent === "ShowHistory" && <AppointmentHistory />}
              {innerComponent === "EmptyButton" && <SpecialOffer setInnerComponent={setInnerComponent} />}
              {innerComponent === null && <></>}
              </div>
            </>
        }
